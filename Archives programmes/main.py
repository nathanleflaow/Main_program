...
objectif_portes_entry = Entry(root, width = 5) ##création entrée et définition largeur
objectif_portes_entry.grid(row= 0, column = 0, sticky = E) ##placement de la zone d'entrée dans le fenêtre
...
#Label(root, text = portes_realisees, font=("Helvetica", 20)).grid(row=1, column=2)
...
#Label(root, text = objectif_portes, font=("Helvetica", 20)).grid(row=1, column=3)
...
#Label(root, text = portes_realisees_avant, font=("Helvetica", 20)).grid(row=3, column=2)
...
#Label(root, text = portes_realisees_arriere, font=("Helvetica", 20)).grid(row=3, column=3)
...
#Label(root, text = defauts_constates, font=("Helvetica", 20)).grid(row=5, column=2)
...
#Label(root, text = defauts_toleres, font=("Helvetica", 20)).grid(row=5, column=3)'''
