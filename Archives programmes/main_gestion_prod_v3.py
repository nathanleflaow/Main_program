...
def on_message(client, userdata, message):
    ...
    identifiant_porte = message
    if identifiant_porte == "avant_conforme":
        print("avant =" + str(portes_realisees_avant))
        portes_realisees_avant += 1
        root.update()
    if identifiant_porte == "arriere_conforme":
        print("arriere" + str(portes_realisees_arriere))
        portes_realisees_arriere += 1
        root.update()
    if identifiant_porte == "avant_retouché":
        #print("arriere" + str(portes_realisees_arriere))
        portes_realisees_arriere += 1
        defauts_constates += 1
        root.update()
    if identifiant_porte == "arriere_retouché":
        #print("arriere" + str(portes_realisees_arriere))
        portes_realisees_arriere += 1
        defauts_constates += 1
        root.update()
    if identifiant_porte == "avant_rebut":
        #print("arriere" + str(portes_realisees_arriere))
        defauts_constates += 1
        root.update()
    if identifiant_porte == "arriere_rebut":
        #print("arriere" + str(portes_realisees_arriere))
        defauts_constates += 1
        root.update()
    portes_realisees = portes_realisees_avant + portes_realisees_arriere
