...
def valide():
    global heure_entree
    client.publish("ECAM_qualite", str(liste_portiere[0]) + ";" + str(heure_entree[0]) + ";" + str(heure_montage_LV[0]) + ";" + get_time())
    print(str(liste_portiere[0]) + ";" + str(heure_entree[0]) + ";" + str(heure_montage_LV[0]) + ";" + get_time())
    del liste_portiere[0]
    del heure_entree[0]
    del heure_montage_LV[0]
    update_image()


width = 900
height = 800
image_avant = PhotoImage(file= "C:/Users/natha/Desktop/ECAM/ECAM/Usine_4.0/Programmes_Python/Main_program/Montage_coulisse_avant.png").zoom(1).subsample(1)
image_arriere = PhotoImage(file= "C:/Users/natha/Desktop/ECAM/ECAM/Usine_4.0/Programmes_Python/Main_program/Montage_coulisse_arriere.png").zoom(16).subsample(10)
